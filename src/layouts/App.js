...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto" id="navApp">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" id="sideApp">
    ...
    <div class="content-wrapper">
        ...
        <section class="content" id="mainApp">

        </section>
    </div>

    <footer class="main-footer" id="footerApp">
